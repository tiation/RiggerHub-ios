...
const require$1 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('rigger-shared.cjs.js', document.baseURI).href)));
const __filename$1 = url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('rigger-shared.cjs.js', document.baseURI).href)));
...
function loadEnvironmentVariables() {
  try {
    ...
    dotenv.config({ path: path.resolve(__dirname$1, '../../', envFile) });
...
//# sourceMappingURL=rigger-shared.cjs.js.map
